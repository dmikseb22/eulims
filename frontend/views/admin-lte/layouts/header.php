        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu" id="referralnotif">
                 ...
                 <li class="dropdown messages-menu" id="pstcnotif">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-bell-o "></i>
                      <span class="label label-success" id="pstccount"><div style='text-align:center;'></div></span>
                    </a>
                    <ul class="dropdown-menu" style="width: 700px!important;">
                      <li class="header" id="pstcheader"></li>
                      <li>
                        <!-- inner menu: contains the actual data -->
                        <ul class="menu">
                        </ul>
                ...
                <li class="dropdown messages-menu" id="paymentnotif">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-bell-o "></i>
                      <span class="label label-success" id="paymentcount"><div style='text-align:center;'></div></span>
                    </a>
                    <ul class="dropdown-menu" style="width: 700px!important;">
                      <li class="header" id="paymentheader"></li>
                      <li>
                        <!-- inner menu: contains the actual data -->
                        <ul class="menu">
                        </ul>
                      </li>
                      <li class="footer"><a href="#">See All Payment Notification Messages</a></li>
                    </ul>
                </li>
...
function getpstcnotification(){  

            $('#pstccount').html("<img src='/images/img-loader64.gif' alt='' height='10px' width='10px'>");
            $('#pstcnotif').load("/ajax/getpstcnotification");
}
function getpaymentnotification(){

            $('#pstccount').html("<img src='/images/img-loader64.gif' alt='' height='10px' width='10px'>");
            $('#paymentnotif').load("/ajax/getpaymentnotification");
}
